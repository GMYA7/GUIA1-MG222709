...
var numero = prompt('Ingrese un numero entero para obtener su tabla de multiplicar','');

//Construyendo la tabla del numero ingresado
document.write("<table>\n\t");
document.write("<caption>Tabla del multiplicar del" + numero + "</caption\n");
document.write("<thead>\n\t");
document.write("<tr>\n\t\t<th>Operacion</th>\h\t\t<th>Producto</th>\n\t</tr>\n");
document.write("</thead>\n\t");
