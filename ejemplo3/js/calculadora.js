...
function init(){
    ...
    //Creando el contennido de la pagina var contenido
    ...
    contenido += "</li>\n";
    contenido += "\t<li>\n";
    contenido += "\t\t<a href=\"javascrpt:void(0)\"><span>Restar</span></a>\n";
    contenido += "</li>\n";
    contenido += "\t<li>\n";
        ...
        switch(i){
            case 0:
                ...
                opciones[i].onclick = function(){
                    resultados.innerHTML = "<><p class\"letterpress\">"+ op1 + " + " + op2 + " = " + (parseFloat(op1) + parseFloat(op2)) + "</p>\n";
                }
                break;
