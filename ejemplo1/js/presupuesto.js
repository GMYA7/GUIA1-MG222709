function init(){
    ...
    html += "\t<li>\n";
    html += "\t\t<a href ='#' class='move-right'>\n";
    html += "\tEl presupuesto asignado para Pediatra es: $"+ pedi + "\n";
    html += "\t\t</a>\n";
    html += "\t</li>\n";
    html += "</ul>\n";

    //Insertando dentro del elemento div el codigo asignado en la variable html div.innerHTML = html
    div.innerHTML = html;

    //Hacer referencia alos elementos h1 dentro de la pagina web
